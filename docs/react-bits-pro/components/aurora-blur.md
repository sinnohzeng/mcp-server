...
```
npx shadcn@latest add @reactbits-starter/aurora-blur-tw
```
...
// Custom aurora layers (up to 4 layers)
...
<AuroraBlur
  ...
  layers={[
    ...
    { color: "#ff0066", speed: 0.4, intensity: 0.5 },

    { color: "#00ffcc", speed: 0.2, intensity: 0.4 },

    { color: "#6600ff", speed: 0.3, intensity: 0.3 },

    { color: "#ffcc00", speed: 0.1, intensity: 0.2 },
...
<AuroraBlur
  ...
  skyLayers={[
    ...
    { color: "#1a0033", blend: 0.6 },

    { color: "#003344", blend: 0.4 },
...
<AuroraBlur width={800} height={600}>
