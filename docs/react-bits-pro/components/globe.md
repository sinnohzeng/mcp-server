...
// Basic usage - auto-sized, rotating globe
...
// Adjust rotation, opacity, and colors
...
<Globe
  ...
  globeColor="rgb(20, 20, 40)"

  cameraAltitude={2.5}

/>

// More active visualization
...
// High detail land representation
...
// Interactive globe with click handler

<Globe

  interactive={true}

  onGlobeClick={(coords) => console.log('Clicked at:', coords)}

/>

// Custom atmosphere and point styling
...
// Complete example with all major props
...
<Globe
  ...
  primaryColor="rgb(0, 255, 200)"

  neutralColor="rgb(100, 150, 200)"

  atmosphereColor="rgba(0, 255, 200, 0.1)"

  globeColor="rgb(15, 25, 35)"
  ...
  onReady={() => console.log("Globe loaded successfully")}

  onGlobeClick={(coords) => console.log("Clicked:", coords)}
